 ...
 */
class MultiTypeMemberItemViewSecond(var binding: ItemMember2Binding) : RecyclerView.ViewHolder(binding.root) {
    ...
    interface OnActionListener {
        fun onClicked(view: MultiTypeMemberItemViewSecond?)
    }
}